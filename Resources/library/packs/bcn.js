...
// Areas Table
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  1, 'Pl. Catalunya', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  2, 'Provença', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  3, 'Gràcia', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  4, 'Muntaner', 2.1424, 41.3985);
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  5, 'Sarrià', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  6, 'Peu del Funicular', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  7, 'Baixador de Vallvidrera', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  8, 'Les Planes', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)',  9, 'La Floresta', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 10, 'Valldoreix', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 11, 'Sant Cugat', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 12, 'Mira-sol', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 13, 'Hospital General', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 14, 'Rubí', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 15, 'Les Fonts', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 16, 'Terrassa - Rambla', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 17, 'Volpelleres', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 18, 'Sant Joan', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 19, 'Bellaterra', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 20, 'Universitat Autònoma', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 21, 'Sant Quirze', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 22, 'Sabadell - Estació', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 23, 'Sabadell - Rambla', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 24, 'Sant Gervasi', 2.1471, 41.4011);
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 25, 'La Bonanova', 2.1365, 41.3980);
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 26, 'Les Tres Torres', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 27, 'Reina Elisenda', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 28, 'Pl. Molina', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 29, 'Pàdua', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 30, 'El Putxet', '', '');
db.execute('INSERT INTO areas (id, name, longitude, latitude) VALUES (?, ?, ?, ?)', 31, 'Av. Tibidabo', '', '');
