...
//@interface FiveMinutesMoreObject : NSObject
//@end

@interface FiveMinutesMoreObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FiveMinutesMoreObject class]])
		{
			for (NSString *key in [[(FiveMinutesMoreObject*)o modules] allKeys])
			{
