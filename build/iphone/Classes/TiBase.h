...
// in simulator we redefine to format for FiveMinutesMore Developer console
...
{\
	NSString * exceptionName = [@"org.fiveminutesmore." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fiveminutesmore";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFiveMinutesMoreNativeItemNone = -1, 
	UIFiveMinutesMoreNativeItemSpinner = -2,
	UIFiveMinutesMoreNativeItemProgressBar = -3,
	
	UIFiveMinutesMoreNativeItemSlider = -4,
	UIFiveMinutesMoreNativeItemSwitch = -5,
	UIFiveMinutesMoreNativeItemMultiButton = -6,
	UIFiveMinutesMoreNativeItemSegmented = -7,
	
	UIFiveMinutesMoreNativeItemTextView = -8,
	UIFiveMinutesMoreNativeItemTextField = -9,
	UIFiveMinutesMoreNativeItemSearchBar = -10,
	
	UIFiveMinutesMoreNativeItemPicker = -11,
	UIFiveMinutesMoreNativeItemDatePicker = -12,
	
	UIFiveMinutesMoreNativeItemInfoLight = -13,
	UIFiveMinutesMoreNativeItemInfoDark = -14,
	
	UIFiveMinutesMoreNativeItemDisclosure = -15,
	
	UIFiveMinutesMoreNativeItemContactAdd = -16
};
